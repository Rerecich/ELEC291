...
void PhaseDifference(void)
{
   ...
   { 
    ...
    TR0 = 0;
    phase_difference = (overflow_count*65536.0+TH0*256.0+TL0)*(12.0/SYSCLK)*(360.0/period);
}
...
//LCDprint("test",1,1); not working
    ...
    ////////////////////////////////////////////////////////////////
     ...
     //   Peak_Voltage();
        ...
        printf("test: %5.3f V || ref: %5.3f V|| period: %5.3f s|| phase shift: %5.3f\r", vrmsTest, vrmsRef, period);
    ...
    else if (strcmp(input,"phase shift")==0) //if reference voltage
    {
        ...
        while(1) {
            ...
            sprintf(str, "%10.7f deg", phase_difference);
            LCDprint(str, 2,1);

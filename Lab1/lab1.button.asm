...
; letters on the LCD  actually i dont use this one            ;
;---------------------------------;
myprogram:
    mov SP, #7FH ;moves SP to 7FH which is a position in memory
    lcall LCD_4BIT ;configure 4-bit mode
...
mov a, #40H ;load th location where we want to store
lcall WriteCommand
mov a,#00H
lcall WriteData
mov a, #00H
...
lcall WriteData   ;Send the data
mov   a,#1bH         ;Load row 3 data
lcall WriteData   ;Send the data
mov   a,#15H         ;Load row 4 data
lcall WriteData   ;Send the data
mov   a,#11H         ;Load row 5 data
lcall WriteData   ;Send the data
mov   a,#0xaH         ;Load row 6 data
lcall WriteData   ;Send the data
mov   a,#0x4H         ;Load row 7 data
lcall WriteData   ;Send the data

...
edit_minutes_alarm:
    ...
    da a 
    mov minute_count, a 
    cjne a, #0x02, flash_minutes_alarm
...
edit_seconds_alarm:
    ...
    cjne a, #0x02, flash_seconds_alarm
...
loop_b:
    ...
    jb BUTTON_1, mainloop  ; if the 'BOOT' button is not pressed skip

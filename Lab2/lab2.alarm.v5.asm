...
flash_clock:
    ...
    ;if button 1 not pressed, keep flashing; else flash hours
...
flash_alarm:
    ...
    ;if button 1 pressed, flash hours; else keep flashing alarm
...
flash_alarm1: ;keep flashing alarm if button not pressed, else flash hours
...
flash_hours_alarm:
    ...
    ;if button 2 pressed, edit hours; else keep flashing and wait for button 1
...
flash_hours_alarm1:
    ...
    ;if button 1 not pressed, continue flashing; else move to minutes
...
flash_minutes_alarm:
    ...
    ;if button 2 not pressed, continue flashing; else move to edit minutes
...
flash_minutes_alarm1:
    ;if button 1 not pressed, continue flashing; else move to flash seconds
...
flash_seconds_alarm:
    ...
    ;if button 2 not pressed, continue flashing; else edit seconds
...
flash_seconds1_alarm:
    ;if button 1 not pressed, keep flashing, else move to am pm
	jb BUTTON_1, flash_seconds_alarm
	jnb BUTTON_1, $	

    ljmp check_AMPM_alarm
...
flash_AM_alarm:
    ...
    ;if button 2 not pressed, continue flashing and wait for confirm; else edit
...
flash_AM1_alarm:
    ;if button 1 not pressed, keep flashing; else confirm
...
setup:
    ...
    mov hour_count_alarm, #0x01
    mov minute_count_alarm, #0x00 
    mov second_count_alarm, #0x00
